...
\begin{figure}[H]
    \centering
    % Первая пара графиков
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{../state_0_normalized.pdf}
        \caption{Состояние 0 (нормализованное)}
        \label{fig:state_0_normalized}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{../state_0_density.pdf}
...
% Вставьте дополнительные пары графиков
\begin{figure}[H]
    \centering
    % Вторая пара графиков
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{../state_1_normalized.pdf}
        \caption{Состояние 1 (нормализованное)}
        \label{fig:state_1_normalized}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{../state_1_density.pdf}
...
% Повторите для остальных состояний...
